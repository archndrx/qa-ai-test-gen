...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-fade-in">
      <div
        className={`w-full max-w-md rounded-xl shadow-2xl border overflow-hidden ${theme.bg}`}
      >
        {/* Header */}
        <div
        ...
        <div className="p-6 space-y-5">
          ...
          <div>
            <label
              className={`block text-xs font-bold uppercase mb-2 ${theme.label}`}
            >
            ...
            >
              <option value="data-testid">
                Prefer [data-testid="..."] (Recommended)
              </option>
            ...
            <p className="text-[10px] opacity-60 mt-1">
              AI will prioritize this selector type when generating code.
            </p>
          </div>
