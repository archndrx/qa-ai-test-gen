...
export const DiffModal: React.FC<DiffModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-fade-in">
      <div
        className={`w-full max-w-6xl h-[85vh] flex flex-col rounded-xl shadow-2xl border overflow-hidden ${
          isDarkMode
      ...
      >
            ...
            styles={{
              variables: {
                dark: {
                  ...
                  addedBackground: "#0f3622",
                  addedColor: "#e6edf3",
                  removedBackground: "#3f1418",
                  removedColor: "#e6edf3",
                  wordAddedBackground: "#1c6b39",
                  wordRemovedBackground: "#8c2626",
        ...
        >
          ...
          <button
            onClick={onApply}
            className="px-6 py-2 rounded text-sm font-bold bg-green-600 hover:bg-green-500 text-white shadow-lg transition flex items-center gap-2"
          >
