    ...
    <div className="lg:col-span-4 flex flex-col gap-4 sticky top-6 h-[calc(100vh-6rem)] overflow-y-auto pr-1 custom-scrollbar">
      ...
      <div className="flex flex-col flex-1 min-h-[200px]">
        ...
        <div className="flex justify-between items-end mb-2">
          <span
            className={`text-[10px] uppercase font-bold tracking-wider ${theme.subtext}`}
          >
            Test Scenario
          </span>
        ...
        />
        <div
          className={`text-[10px] text-right mt-1 flex justify-end gap-1 items-center ${
            isDarkMode ? "text-gray-400" : "text-gray-500"
          }`}
        >
          <span>
            Press <kbd className="font-bold">Ctrl</kbd> +{" "}
          ...
          return (
            ...
            >
              <div className="flex justify-between mb-2">
                ...
                <span
                  className={`px-2 rounded text-xs font-bold flex items-center ${badgeColor}`}
                >
                  {derivedPriority}
                </span>
              </div>
              ...
              <div className="mt-2">
                <p
                  className={`text-xs pt-2 border-t border-dashed ${
                    theme.subtext
